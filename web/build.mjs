...
for (const name of ['index.html','app.mjs','worker.mjs','pixels.mjs','zip.mjs','delivery.mjs','project-store.mjs','presets.mjs','revisions.mjs','editor.mjs','composition.mjs','image-limits.mjs','project-archive.mjs','manifest.webmanifest','icon.svg','sw.js']) await copyFile(new URL(name,import.meta.url),new URL(name,out));
