...
2026-09-13：已实现浏览器内批次持久化、刷新恢复与多页面写入冲突保护，真实验证见 product-workflow-development.md。2026-09-16 已补上 `.rembg.zip` 项目备份，导出原图、结果、规格、确认和失败状态，并在导入时校验 CRC；它仍不包含模型缓存或授权密钥。
